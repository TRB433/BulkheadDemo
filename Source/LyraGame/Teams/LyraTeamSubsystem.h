...
public:
	...
	//bool hitFriendly(const UObject* Instigator, const UObject* Target, bool bAllowDamageToSelf = true) const;
	...
	//creating bool that can be used in blueprints to allow team damage	
	UPROPERTY(EditAnywhere, BlueprintReadWrite, Category = "Teams")
	//can be set to true on event start in level blueprint to enable team damage
	bool teamDamage;	
